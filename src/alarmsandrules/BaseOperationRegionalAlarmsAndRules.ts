...
export abstract class BaseOperationRegionalAlarmsAndRules extends Construct implements IBaseOperationRegionalAlarmsAndRules {
  ...
  constructor(scope: Construct, id: string, props: BaseOperationRegionalAlarmsAndRulesProps) {
    ...
    this.availabilityAlarm = AvailabilityAndLatencyAlarmsAndRules.createRegionalAvailabilityAlarm(
      this,
      props.availabilityMetricDetails,
      props.nameSuffix,
    );
    this.latencyAlarm = AvailabilityAndLatencyAlarmsAndRules.createRegionalLatencyAlarm(
      this,
      props.latencyMetricDetails,
      props.nameSuffix,
    );
    this.availabilityOrLatencyAlarm = AvailabilityAndLatencyAlarmsAndRules.createRegionalCustomerExperienceAlarm(
      this,
