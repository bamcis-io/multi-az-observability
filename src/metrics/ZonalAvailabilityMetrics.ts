...
export class ZonalAvailabilityMetrics {
  ...
  static createZonalAvailabilityMetric(props: ZonalAvailabilityMetricProps): IMetric {
    return AvailabilityAndLatencyMetrics.createAvailabilityMetric(props, props.metricDetails.metricDimensions.zonalDimensions(props.availabilityZoneId, Fn.ref('AWS::Region')));
  }
}