...
export class RegionalLatencyMetrics {
  ...
  static createRegionalLatencyMetrics(props: RegionalLatencyMetricProps): IMetric[] {
    return AvailabilityAndLatencyMetrics.createLatencyMetrics(props, props.metricDetails.metricDimensions.regionalDimensions(Fn.ref('AWS::Region')));
  }
  ...
  static createRegionalAverageLatencyMetric(props: RegionalLatencyMetricProps): IMetric {
    return AvailabilityAndLatencyMetrics.createAverageLatencyMetric(props, props.metricDetails.metricDimensions.regionalDimensions(Fn.ref('AWS::Region')));
  }
  ...
  static createRegionalLatencyCountMetric(props: RegionalLatencyMetricProps): IMetric {
    return AvailabilityAndLatencyMetrics.createLatencyCountMetric(props, props.metricDetails.metricDimensions.regionalDimensions(Fn.ref('AWS::Region')));
  }
  ...
  static createRegionalServiceLatencyCountMetrics(props: ServiceLatencyMetricProps): IMetric[] {
    ...
    props.latencyMetricProps.forEach((prop: LatencyMetricProps, index: number) => {
      ...
      let operationRegionalMetric: IMetric = this.createRegionalLatencyCountMetric(prop);
