...
export class AvailabilityAndLatencyMetrics {
  ...
  /**
     ...
     * @returns
     */
  static createAvailabilityMetric(props: AvailabilityMetricProps, dimensions: { [key: string]: string }): IMetric {
  ...
  /**
     ...
     * @returns
     */
  static createLatencyMetrics(props: LatencyMetricProps, dimensions: { [key: string]: string }): IMetric[] {
    let names: string[];
  ...
  /**
     ...
     * @param dimensions
     */
  static createAverageLatencyMetric(props: LatencyMetricProps, dimensions: { [key: string]: string }): IMetric {
  ...
  /**
     ...
     * @returns
     */
  static createLatencyCountMetric(props: LatencyMetricProps, dimensions: { [key: string]: string }): IMetric {
    let latencyMetrics: IMetric[] = AvailabilityAndLatencyMetrics.createLatencyMetrics(props, dimensions);
