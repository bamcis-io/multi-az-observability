...
export class ZonalLatencyMetrics {
  ...
  static createZonalLatencyMetrics(props: ZonalLatencyMetricProps): IMetric[] {
    return AvailabilityAndLatencyMetrics.createLatencyMetrics(props, props.metricDetails.metricDimensions.zonalDimensions(props.availabilityZoneId, Fn.ref('AWS::Region')));
  }
  ...
  static createZonalAverageLatencyMetric(props: ZonalLatencyMetricProps): IMetric {
    return AvailabilityAndLatencyMetrics.createAverageLatencyMetric(props, props.metricDetails.metricDimensions.zonalDimensions(props.availabilityZoneId, Fn.ref('AWS::Region')));
  }
  ...
  static createZonalCountLatencyMetric(props: ZonalLatencyMetricProps): IMetric {
    return AvailabilityAndLatencyMetrics.createLatencyCountMetric(props, props.metricDetails.metricDimensions.zonalDimensions(props.availabilityZoneId, Fn.ref('AWS::Region')));
  }
  ...
  static createZonalServiceLatencyMetrics(props: ServiceLatencyMetricProps): IMetric[] {
    ...
    props.latencyMetricProps.forEach((prop: LatencyMetricProps, index: number) => {

      let operationZonalMetric: IMetric = this.createZonalCountLatencyMetric(prop as ZonalLatencyMetricProps);
